import{iQ as $e,dm as x,dJ as k,et as Oe,ki as et,gx as Bt,f4 as Ht,iI as Wt,fR as V,iy as kt,pC as Ut,k3 as Yt,wP as tt,x as c,y as H,z as at,wQ as Zt,wR as qt,ko as Q,ej as ot,kn as Fe,iG as Ge,iw as Xt,ma as Jt,wS as U,_ as he,gB as rt,k2 as ne,bn as re,cJ as Kt,cL as Qt,l as ea,ax as ta,jE as aa,c6 as oa,dv as z,fc as ra,iX as ia,or as na,dO as sa,dy as la,dA as ca,dl as we,dn as da,dR as je,dw as ua,iu as ha}from"./index-D8xrrNs5.js";import{ab as P,i as me,d as pe,aX as I,a as it,aY as fe,aZ as nt,a_ as st,a$ as ma,b0 as W,b1 as pa,b2 as fa,ad as va,f as ga,b3 as J,r as N,a2 as ae,D as A,E as D,b4 as G,G as K,b as y,I as j,al as xa,H as ba,b5 as wa,b6 as lt,q as se,aj as ct,o as dt,aU as ut,g as ya,j as Ne,k as ve,s as ht,b7 as Ma,aH as Ta,u as _a,v as Be,ah as Sa,aa as _,aF as Ie,ag as Ca,b8 as za,c as ee,b9 as $a,X as oe,ba as Oa,M as Fa,bb as mt,a9 as le,F as pt,L as ft,K as vt,bc as gt,J as xt,N as Na,T as Ia,O as La,P as Va,Q as Pa,R as Ra,U as Ea,V as Aa,W as Da,Y as Ga,x as m,A as ja,bd as ye,be as Me,a1 as Ba,aq as Ha,B as Wa,aS as ka,a3 as Ua,az as Ya}from"./OutputColorHighlightOID.glsl-FwqNPTxB.js";import{t as ze,Q as Le}from"./InterleavedLayout-UHYr68BC.js";import{s as S,T as bt,g as ce,I as He}from"./BufferView-Dzm_6Gf-.js";import{r as Za}from"./VertexBuffer-Cd5gIXyp.js";import{g as qa}from"./plane-DY_3KHRQ.js";import{T as Ve,d as Pe,_ as Xa}from"./renderState-CKc66y4x.js";import{t as i,n as p}from"./glsl-B5bJgrnA.js";import{s as ge}from"./ShaderBuilder-C-d-nx87.js";function xe(a,e){switch(a.fragment.code.add(i`vec3 screenDerivativeNormal(vec3 positionView) {
...
return color;
}`)}const Ue=k();function _t(a,e){const{hasModelTransformation:t,instancedDoublePrecision:r,instanced:o,output:s,hasVertexTangents:d}=e;t&&(a.vertex.uniforms.add(new ma("model",l=>l.modelTransformation??Ge)),a.vertex.uniforms.add(new I("normalLocalOriginFromModel",l=>(Xt(Ue,l.modelTransformation??Ge),Ue)))),o&&r&&(a.attributes.add("instanceModelOriginHi","vec3"),a.attributes.add("instanceModelOriginLo","vec3"),a.attributes.add("instanceModel","mat3"),a.attributes.add("instanceModelNormal","mat3"));const n=a.vertex;r&&(n.include(Ja,e),n.uniforms.add(new W("viewOriginHi",l=>pa(V(ie,l.camera.viewInverseTransposeMatrix[3],l.camera.viewInverseTransposeMatrix[7],l.camera.viewInverseTransposeMatrix[11]),ie)),new W("viewOriginLo",l=>fa(V(ie,l.camera.viewInverseTransposeMatrix[3],l.camera.viewInverseTransposeMatrix[7],l.camera.viewInverseTransposeMatrix[11]),ie)))),n.code.add(i`
    ...
    }`)}const ie=x();function St(a,e){a.varyings.add("colorMixMode","int"),a.varyings.add("opacityMixMode","int"),a.vertex.uniforms.add(new ga("symbolColorMixMode",t=>J[t.colorMixMode])),e.hasSymbolColors?(a.vertex.include(fe),a.vertex.include(nt),a.vertex.include(st),a.attributes.add("symbolColor","vec4"),a.vertex.code.add(i`
...
forwardTextureCoordinates();`),a.include(B,e),r.main.add(i`
        ...
        ${p(n,i`vec4 texColor = texture(tex, ${f?"colorUV":"vuv0"});
                discardOrAdjustAlpha(texColor);`)}`);break;case 4:case 5:case 6:case 7:case 10:A(t,e),a.include(D),a.include(G,e),a.include(K,e),a.include(po,e),r.include(j,e),a.include(ba,e),wa(a),o.add("depth","float",{invariant:!0}),n&&r.uniforms.add(new y("tex",v=>v.texture)),t.main.add(i`vpos = getVertexInLocalOriginSpace();
vpos = subtractOrigin(vpos);
vpos = addVerticalOffset(vpos, localOrigin);
...
vpos = addVerticalOffset(vpos, localOrigin);
gl_Position = transformPosition(proj, view, vpos);
forwardTextureCoordinates();`),r.include(j,e),a.include(B,e),a.include(xa,e),r.main.add(i`
        discardBySlice(vpos);
        ${p(n,i`vec4 texColor = texture(tex, ${f?"colorUV":"vuv0"});
                discardOrAdjustAlpha(texColor);`)}
...
}`))}const go=3e5,Ye=5e5,_e=4;function zt(){const a=new ge,e=a.fragment;a.include(dt);const t=(_e+1)/2,r=1/(2*t*t);return e.include(ut),e.uniforms.add(new y("depthMap",o=>o.depthTexture),new se("tex",o=>o.colorTexture),new ya("blurSize",o=>o.blurSize),new N("projScale",(o,s)=>{const d=s.camera.distance;return d>5e4?Math.max(0,o.projScale-(d-5e4)):o.projScale})),e.code.add(i`
...
}`),a.outputs.add("fragOcclusion","float"),e.uniforms.add(new y("normalMap",t=>t.normalTexture),new y("depthMap",t=>t.depthTexture),new N("projScale",t=>t.projScale),new y("rnm",t=>t.noiseTexture),new ct("rnmScale",(t,r)=>ne(Xe,r.camera.fullWidth/t.noiseTexture.descriptor.width,r.camera.fullHeight/t.noiseTexture.descriptor.height)),new N("intensity",t=>t.intensity),new Ta("screenSize",t=>ne(Xe,t.camera.fullWidth,t.camera.fullHeight))).main.add(i`
...
}`))}function Er(a,e){a.include(Ie),a.code.add(i`
...
inputs.diffuseColor = inputs.albedoLinear * (vec3(1.0) - inputs.f0) * (1.0 - inputs.metalness);`),e.useFillLights?t.uniforms.add(new Ca("hasFillLights",n=>n.enableFillLights)):t.constants.add("hasFillLights","bool",!1),t.code.add(i`vec3 ambientDir = vec3(5.0 * groundNormal[1] - groundNormal[0] * groundNormal[2], - 5.0 * groundNormal[0] - groundNormal[2] * groundNormal[1], groundNormal[1] * groundNormal[1] + groundNormal[0] * groundNormal[0]);
...
}`);break;default:$e(e.doubleSidedMode);case 3:}}function Ft(a,e){const t=e.pbrMode,r=a.fragment;if(t!==2&&t!==0&&t!==1)return void r.code.add(i`void applyPBRFactors() {}`);if(t===0)return void r.code.add(i`void applyPBRFactors() {}
...
float occlusion;`),o&&r.uniforms.add(l===1?new y("texMetallicRoughness",u=>u.textureMetallicRoughness):new se("texMetallicRoughness",u=>u.textureMetallicRoughness)),d&&r.uniforms.add(l===1?new y("texOcclusion",u=>u.textureOcclusion):new se("texOcclusion",u=>u.textureOcclusion)),r.uniforms.add(l===1?new ee("mrrFactors",u=>u.mrrFactors):new $a("mrrFactors",u=>u.mrrFactors)),r.code.add(i`
...
return texture(_shadowMap, uvzShadow);
  ...
  `)}function Do(a){a.include(Eo),a.fragment.uniforms.add(new Ao("shadowMap",({shadowMap:e})=>e.depthTexture)).code.add(i`float readShadowMap(const in vec3 _worldPos, float _linearDepth) {
...
return mix(mrr, vec3(0.0, 1.0, 0.04), snow);
  ...
  `),e.include(Ot,a),o.include(Re,a),e.include(B,a),o.include(j,a),e.include(xt,a),le(o,a),o.uniforms.add(r.uniforms.get("localOrigin"),new ee("ambient",b=>b.ambient),new ee("diffuse",b=>b.diffuse),new N("opacity",b=>b.opacity),new N("layerOpacity",b=>b.layerOpacity)),F&&o.uniforms.add(new y("tex",b=>b.texture)),e.include(Ft,a),o.include(Ee,a),o.include(Pt),e.include(No,a),o.include(Rt,a),Ae(o),De(o),te(o),o.main.add(i`
    discardBySlice(vpos);
  ...
  `);const{hasColorTexture:M,hasColorTextureTransform:C}=a;return e.include(Ot,a),o.include(Re,a),e.include(B,a),o.include(j,a),e.include(xt,a),le(o,a),ue(o),Ae(o),De(o),o.uniforms.add(r.uniforms.get("localOrigin"),r.uniforms.get("view"),new ee("ambient",g=>g.ambient),new ee("diffuse",g=>g.diffuse),new N("opacity",g=>g.opacity),new N("layerOpacity",g=>g.layerOpacity)),M&&o.uniforms.add(new y("tex",g=>g.texture)),e.include(Ft,a),o.include(Ee,a),o.include(Pt),o.include(Rt,a),te(o),o.main.add(i`
      discardBySlice(vpos);
      discardByTerrainDepth();
